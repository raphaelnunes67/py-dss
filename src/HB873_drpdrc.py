...
if __name__ == '__main__':
    calculate_drp_drc_for_each_load('../results/HB873_results/voltvar_on')
    calculate_drp_drc_for_each_load('../results/HB873_results/voltvar_off')

    calculate_comp_total('../results/HB873_results/')
